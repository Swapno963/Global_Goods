  ...
  return (
    <div className="w-full max-w-xl relative flex  ml-auto">
      ...
      <button
        ...
        className="bg-[#4d6ac8] border border-primary rounded-md ml-3 text-white px-8 py-3 font-bold rounded-r-md hover:bg-transparent hover:text-primary transition  md:flex"
      >
        Search
      </button>
    </div>
